...
insert into tag (id, name, user_id) values (5,'Tag5',1);
...
insert into note_tags (note_id,tags_id) values (1,2);
insert into note_tags (note_id,tags_id) values (3,2);
insert into note_tags (note_id,tags_id) values (3,5);
insert into note_tags (note_id,tags_id) values (4,3);
insert into note_tags (note_id,tags_id) values (4,4);